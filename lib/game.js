...
GameTable.prototype.checkLengthCardDeck=function(){
	if(this.cardDecks[this.activeDeck].length>=(this.countPlayersInGame+1)*5)
		return;
...
GameTable.prototype.standFromPlace=function(place,sessionID){
		...
		switch(this.gameStatus){
			case 1:this.betsDone(place);
				break;
			case 2:this.initTradeRound();
				break;
		}
}
...
GameTable.prototype.updGameStatus=function(){
