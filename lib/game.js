...
GameTable.prototype.addCardToPlayer=function(player){
	if(player.place!="dealer"&&(!player.playerStatus==11||!player.playerStatus==12))
		return;
...
GameTable.prototype.initTradeRound=function(){
	...
	if(tempActivePlayers[this.activePlayer].cards.length<2||tempActivePlayers[this.activePlayer].playerStatus!=12)
		return;
