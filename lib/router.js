...
exports.router=function(app){
	...
	app.get("/register",pass.alreadyAuthenticated,function(req,res) {
	  	res.render(__dirname+'/../views/template.ejs',{title:"Registration",header:parts.header(false),footer:parts.footer(false,parts.chat()),content:content.register()});
	});
	app.get("/signup",pass.alreadyAuthenticated,function(req,res) {
	  	res.render(__dirname+'/../views/template.ejs',{title:"SignUp",header:parts.header(false),footer:parts.footer(false,parts.chat()),content:content.signup()});
	});
