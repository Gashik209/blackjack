		...
		for(var key in game.gameTables){
			...
			for(var player in game.gameTables[key].players){
				if(game.gameTables[key].players[player]!=null){
					content+="player_"+player+": "+game.gameTables[key].players[player].sessionID+"<br>";
					content+="player_"+player+": "+game.gameTables[key].players[player].cards+"<br>";
					content+="player_"+player+": "+game.gameTables[key].players[player].cardScore+"<br>";
					content+="player_"+player+": "+game.gameTables[key].players[player].playerStatus+"<br>";
				}
				else{
